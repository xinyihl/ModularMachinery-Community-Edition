...
public abstract class BlockFluidHatch extends BlockMachineComponent implements BlockCustomName, BlockVariants {
    protected static final PropertyEnum<FluidHatchSize> BUS_TYPE = PropertyEnum.create("size", FluidHatchSize.class);

    public BlockFluidHatch() {
        super(Material.IRON);
        setHardness(2F);
        setResistance(10F);
