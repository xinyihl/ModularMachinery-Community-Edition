...
public class ModularMagicComponents {
    ...
    public static final ResourceLocation KEY_COMPONENT_STARLIGHT = new ResourceLocation(ModularMachinery.MODID, "starlight_output");
    ...
    public static void initComponents() {
        if (Mods.ASTRAL_SORCERY.isPresent()) {
            ...
            registerComponent(new ComponentStarLightOutput(), KEY_COMPONENT_STARLIGHT);
        }
